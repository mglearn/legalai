...
BreakoutI18n.register('pages', {
  en: {
    ...
    "pres.h1":"Presentations", "about.h":"About this session", "pres.sub":"Four self-contained decks, each with speaker notes.",
  ...
  es: {
    ...
    "pres.h1":"Presentaciones", "about.h":"Acerca de esta sesión", "pres.sub":"Cuatro presentaciones independientes, cada una con notas del orador.",
  ...
  vi: {
    ...
    "pres.h1":"Bài trình chiếu", "about.h":"Về phiên này", "pres.sub":"Bốn bộ trình chiếu độc lập, mỗi bộ có ghi chú cho người trình bày.",
  ...
  ar: {
    ...
    "pres.h1":"العروض التقديمية", "about.h":"عن هذه الجلسة", "pres.sub":"أربع عروض مستقلة، لكل منها ملاحظات للمتحدث.",
  ...
  hi: {
    "pg.resources":"संसाधन",
    "pres.h1":"प्रस्तुतियाँ", "about.h":"इस सत्र के बारे में", "pres.sub":"चार स्वतंत्र प्रस्तुतियाँ, प्रत्येक में वक्ता नोट्स।",
  ...
  ur: {
    "pg.resources":"وسائل",
    "pres.h1":"پریزنٹیشنز", "about.h":"اس سیشن کے بارے میں", "pres.sub":"چار خودمختار پریزنٹیشنز، ہر ایک میں مقرر نوٹس۔",
  ...
  zh: {
    "pg.resources":"资源",
    "pres.h1":"演示", "about.h":"关于本场次", "pres.sub":"四套独立的演示，每套都附有演讲者备注。",
